...
const CalendarAddIcon = ({ className, onClick }) => {
  return (
    <span className={className} onClick={onClick}>
      <svg className="calendar-add-svg" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792">
